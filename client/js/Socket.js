  ...
  flipSideDeckButton.addEventListener('click', function() {
    if (spareCardsPileOneArray.length > 0) {
      socket.emit("checkIfStaleMate", {
        isLocalArrayEmpty: false
      });
    } else {
      console.log("No Pile Cards Left");
      socket.emit("checkIfStaleMate", {
        isLocalArrayEmpty: true
      });
    }
  });
      ...
      if (event.keyCode === 49) {
        ...
        if (keyCombos.one === true && keyCombos.q === true) {
          socket.emit('keyPress', {
            inputId: 'firstHandCardToPileOne',
            state: true
          });
          if (playerNum == 0)
          ...
          socket.emit('keyPress', {
            inputId: 'secondHandCardToPileOne',
            state: true
          });
          if (playerNum == 0)
          ...
          socket.emit('keyPress', {
            inputId: 'thirdHandCardToPileOne',
            state: true
          });
          if (playerNum == 0)
          ...
          socket.emit('keyPress', {
            inputId: 'fourthHandCardToPileOne',
            state: true
          });
          if (playerNum == 0)
          ...
          socket.emit('keyPress', {
            inputId: 'firstHandCardToPileTwo',
            state: true
          });
          if (playerNum == 0)
          ...
          socket.emit('keyPress', {
            inputId: 'secondHandCardToPileTwo',
            state: true
          });
          if (playerNum == 0)
          ...
          socket.emit('keyPress', {
            inputId: 'thirdHandCardToPileTwo',
            state: true
          });
          if (playerNum == 0)
          ...
          socket.emit('keyPress', {
            inputId: 'fourthHandCardToPileTwo',
            state: true
          });
          if (playerNum == 0)
